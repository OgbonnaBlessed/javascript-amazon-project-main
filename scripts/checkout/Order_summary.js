...
import { deliveryOptions, getDeliveryOption, calculateDeliveryDate } from "../../data/Delivery_options.js";
...
export function renderOrderSummary() {
 ...
 cart.forEach((cartItem) => {
  ...
  function checkoutQuantity() {
    ...
    let quantity = updateNewQuantity()

    document.querySelector('.js-return-to-home').innerHTML = `${quantity} items`;
  }
